...
plot 'data.tsv' using 0:3  notitle with lines linecolor rgb "#5B9BD5", \
     ...
     'data.tsv' using 0:7  notitle with lines linecolor rgb "#4472C4", \
     'data.tsv' using 0:8  notitle with lines linecolor rgb "#70AD47", \
     'data.tsv' using 0:9  notitle with lines linecolor rgb "#255E91", \
     'data.tsv' using 0:10 notitle with lines linecolor rgb "#9E480E", \
     'data.tsv' using 0:11 notitle with lines linecolor rgb "#636363", \
     'data.tsv' using 0:12 notitle with lines linecolor rgb "#997300"
