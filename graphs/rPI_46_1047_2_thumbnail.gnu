...
plot 'data.csv' using 0:2  notitle with lines linecolor rgb "#5B9BD5", \
     ...
     'data.csv' using 0:6  notitle with lines linecolor rgb "#9E480E"
...
plot 'data.csv' using 0:7  notitle with lines linecolor rgb "#5B9BD5", \
     'data.csv' using 0:8  notitle with lines linecolor rgb "#ED7D31"
