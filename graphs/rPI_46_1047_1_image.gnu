...
plot 'data.csv' using 0:2  title "Hannah's Box"   with lines linecolor rgb "#5B9BD5", \
     'data.csv' using 0:3  title "Pete's Box"     with lines linecolor rgb "#ED7D31", \
     'data.csv' using 0:4  title "Ed's Box"       with lines linecolor rgb "#A5A5A5", \
     'data.csv' using 0:5  title "Tsunami"        with lines linecolor rgb "#FFC000", \
     'data.csv' using 0:6  title "Aircon Left"    with lines linecolor rgb "#4472C4", \
     ...
     'data.csv' using 0:9  title "Aircon Right"   with lines linecolor rgb "#9E480E", \
     ...
     'data.csv' using 0:12 title "Aircon Control" with lines linecolor rgb "#994300"
